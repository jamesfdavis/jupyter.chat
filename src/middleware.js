...
export class Middleware {
   ...
   * 
   * @param  {} context - context object that is passed through the middleware stack. When handling errors, this is assumed to have a `response` property.
   * @param  {} next - Called when all middleware is complete (assuming all continued by calling respective 'next' functions)
   * @param  {} done - Initial (final) completion callback. May be wrapped by executed middleware.
   */
  ...
  /**
   * Registers new milddleware.
   * A generic pipeline component function that can either
